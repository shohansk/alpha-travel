        ...
        <div  className="container ">
...

            {
                ...
                <div className="w-100 text-center mt-2">
                    Already you have an account? <span href="" onClick={()=>setCreateNewUser(!createNewUser)}>Log Int</span>
            ...
            <div className="w-100 text-center mt-2">
               Don"t have an account? <span href="" onClick={()=>setCreateNewUser(!createNewUser)}> create an account</span>
           ...
           <Form className="w-50 mx-auto">
            ...
            <Button type="submit" className="w-100 mb-4 rounded-pill" variant="outline-secondary">Sign In With Facebook</Button>
            <Button  className="w-100" variant="outline-secondary" onClick={handleGoogleSignIn} >Sign In With Google</Button>
            </Form>
